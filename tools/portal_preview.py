...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path=='/':
            ...
            self.reply(dict(config_version=1,wifi_ssid='',has_password=False,monthly_salary=40000,work_days=31,work_start='09:00',lunch_start='12:00',lunch_end='13:00',work_end='18:00',timezone='Asia/Taipei'))
